package it.ht.rcs.console.build.rest
{
  ...
  public class DBBuildDemo implements IDBBuild
  {
    ...
    public function exploit_all(onResult:Function=null, onFault:Function=null):void
    {
      ...
      items.addItem(new Exploit({id: 'HT-2012-003', name: 'Safari 5.1', version: 20120101, platform: 'osx', category: 'zeroday', embed: false, description: 'This is a test exploit for OSX'}) );
