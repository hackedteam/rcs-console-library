package it.ht.rcs.console.build.rest
{
  ...
  public class DBBuildDemo implements IDBBuild
  {
    ...
    public function exploit_all(onResult:Function=null, onFault:Function=null):void
    {
      ...
      items.addItem(new Exploit({id: 'HT-2012-003', name: 'Safari 5.1', version: 20120101, platform: 'osx', category: 'zeroday', embed: false, params: new ExploitParam({combo: new ArrayCollection(['First Option', 'Second Option'])}), description: 'This is a test exploit for OSX'}) );
      items.addItem(new Exploit({id: 'HT-2012-004', name: 'PDF < 4.3.3', version: 20120101, platform: 'ios', category: 'zeroday', embed: false, params: new ExploitParam({combo: new ArrayCollection(['First Option', 'Second Option'])}), description: 'This is a test exploit for iOS'}) );
