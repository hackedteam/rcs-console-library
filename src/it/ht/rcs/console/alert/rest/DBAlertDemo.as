package it.ht.rcs.console.alert.rest
{
  ...
  public class DBAlertDemo implements IDBAlert
  {
    ...
    public function all(onResult:Function=null, onFault:Function=null):void
    {
      ...
      items.addItem(new Alert({_id: '1', enabled:true, suppression: 600, type: 'MAIL', keywords: "HT", priority: 0, evidence: '*', path:new ArrayCollection(['*'])}) );
      items.addItem(new Alert({_id: '2', enabled:true, suppression: 600, type: 'LOG', keywords: "bomb", priority: 0, evidence: '*', path:new ArrayCollection(['1', '2', '3'])}) );
