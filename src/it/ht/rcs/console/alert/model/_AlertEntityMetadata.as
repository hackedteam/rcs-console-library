...
internal class _AlertEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("suppression", "enabled", "updated_at", "keywords", "_id", "priority", "evidence", "path", "created_at", "user_id", "type");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("suppression", "enabled", "updated_at", "keywords", "_id", "priority", "evidence", "path", "created_at", "user_id", "type");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("suppression", "enabled", "updated_at", "keywords", "_id", "priority", "evidence", "path", "created_at", "user_id", "type");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("suppression", "enabled", "updated_at", "keywords", "_id", "priority", "evidence", "path", "created_at", "user_id", "type");
