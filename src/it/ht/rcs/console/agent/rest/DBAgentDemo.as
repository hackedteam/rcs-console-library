  ...
  public class DBAgentDemo implements IDBAgent
  {
    ...
    */
    ...
    public static var agents:ArrayCollection = new ArrayCollection([
        ...
        new Agent({_id:"4e26a843963d350f4e000004", _kind:"agent", desc:"Joey's Mac", ident:"RCS_0000000004", counter: 1, name: "joey mac",path :["4df7246d963d350964000001", "4e268719963d350658000003"], stat: new Stat({_id:"4e26a884963d350f4e00000b",evidence: {}, grid_size: 0, size: 0}), status: "open", upgradable: false}),
        new Agent({_id:"4e26a84a963d350f4e000005", _kind:"agent", desc:"Joey's PC", ident:"RCS_0000000004", counter: 2, name: "joey pc",path :["4df7246d963d350964000001", "4e268719963d350658000003"], stat: new Stat({_id:"4e26a889963d350f4e00000c",evidence: {}, grid_size: 0, size: 0}), status: "open", upgradable: false}),
        new Agent({_id:"4e26a850963d350f4e000006", _kind:"agent", desc:"Joey's Mobile", ident:"RCS_0000000005", counter: 1, name: "joey mob",path :["4df7246d963d350964000001", "4e268719963d350658000003"], stat: new Stat({_id:"4e26a890963d350f4e00000d",evidence: {}, grid_size: 0, size: 0}), status: "open", upgradable: false}),
        
        // Guido (BlackJack)
        new Agent({_id:"4e26a857963d350f4e000007", _kind:"agent", desc:"Guido's PC", ident:"RCS_0000000006", name: "guido pc",path :["4e259fe5963d35425c000001", "4e268724963d350658000004"], stat: new Stat({_id:"4e26a895963d350f4e00000e",evidence: {}, grid_size: 0, size: 0}), status: "open", upgradable: false}),
        new Agent({_id:"4e26a85d963d350f4e000008", _kind:"agent", desc:"Guido's iPad", ident:"RCS_0000000007", name: "guido ipad",path :["4e259fe5963d35425c000001", "4e268724963d350658000004"], stat: new Stat({_id:"4e26a89a963d350f4e00000f",evidence: {}, grid_size: 0, size: 0}), status: "open", upgradable: false}),
        
        // Dmitry Vitaly (All In)
        new Agent({_id:"4e26a862963d350f4e000009", _kind:"agent", desc:"Dmitry's Cellphone", ident:"RCS_0000000008", name: "dimitry cell",path :["4e25a173963d354260000003", "4e26872b963d350658000005"], stat: new Stat({_id:"4e26a8a0963d350f4e000010",evidence: {}, grid_size: 0, size: 0}), status: "open", upgradable: false})
      ]);
