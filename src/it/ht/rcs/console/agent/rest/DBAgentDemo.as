package it.ht.rcs.console.agent.rest
{
  ...
  public class DBAgentDemo implements IDBAgent
  {
    ...
    public static var agents:ArrayCollection = new ArrayCollection([
      ...
      // John Doe (SwordFish)
      new Agent({ _id:"a1", _kind: "agent", name: "Laptop (1)",      desc:"John's Laptop",               status: "open",   path :["o1", "t1"], type: "desktop", platform: "android", version: 10, ident:"RCS_01", counter: 1, upgradable: false, stat: new Stat({ _id: "s1", last_sync: 1307515166,
