    ...
    public function all(onResult:Function=null, onFault:Function=null):void
    {
      ...
      var a:Array = [
        new Proxy({_id: 'p1', address: '192.168.1.101', desc: 'Desc 192.168.1.101', name: 'Proxy 1', poll: false, port: 4444, redirect: '', redirection_tag: '', created_at: '2011-06-22T17:29:41+02:00', updated_at: '2011-06-22T17:29:41+02:00', version: 0,
                   rules: [new ProxyRule({_id: '', action: 'INJECT-EXE', action_param: 'document.doc', disable_sync: false, enabled: true,  probability: 0,  resource: '.doc', target: 'Target 1'}),
                           new ProxyRule({_id: '', action: 'REPLACE',    action_param: 'RCS_0001',     disable_sync: true,  enabled: false, probability: 10, resource: '.exe', target: 'Target 2'})]}),
