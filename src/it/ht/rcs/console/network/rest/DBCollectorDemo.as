  ...
  public class DBCollectorDemo implements IDBCollector
  {
    ...
    public function all(onResult:Function=null, onFault:Function=null):void
    {
      ...
      var a:Array = [
        ...
        new Collector({name:    'Collector node 2',  _id: 'c2',  prev:   null,  next:   null,  address: '127.0.0.1', type:  'local', port:    0, _mid:  9, configured:  true, desc: 'Desc 192.168.1.102', instance: 'dbca550f1174f3028308344c4d58545dRSS', poll: false, created_at: '2011-06-22T17:29:41+02:00', updated_at: '2011-06-22T17:29:41+02:00', version: 0}),
        ...
        new Collector({name: 'Prod Public Address',  _id: 'a0',  prev: ['c1'],  next:   null,  address: '192.168.2.170', type: 'remote', port: 4444, _mid:  3, configured:  true, desc: 'Desc 192.168.1.170', instance:                                    '', poll: false, created_at: '2011-06-22T17:29:41+02:00', updated_at: '2011-06-22T17:29:41+02:00', version: 0}),
        new Collector({name:        'Anonymizer 1',  _id: 'a1',  prev: ['c3'],  next: ['a2'],  address: '192.168.2.171', type: 'remote', port: 4444, _mid: 19, configured:  true, desc: 'Desc 192.168.1.171', instance:                                    '', poll: false, created_at: '2011-06-22T17:29:41+02:00', updated_at: '2011-06-22T17:29:41+02:00', version: 0}),
        new Collector({name:        'Anonymizer 2',  _id: 'a2',  prev: ['a1'],  next:   null,  address: '192.168.2.172', type: 'remote', port: 4444, _mid: 20, configured:  true, desc: 'Desc 192.168.1.172', instance:                                    '', poll: false, created_at: '2011-06-22T17:29:41+02:00', updated_at: '2011-06-22T17:29:41+02:00', version: 0}),
        new Collector({name:        'Anonymizer 3',  _id: 'a3',  prev: ['c5'],  next:   null,  address: '192.168.2.173', type: 'remote', port: 4444, _mid: 21, configured:  true, desc: 'Desc 192.168.1.173', instance:                                    '', poll: false, created_at: '2011-06-22T17:29:41+02:00', updated_at: '2011-06-22T17:29:41+02:00', version: 0}),
