package it.ht.rcs.console.accounting.rest
{
  public interface IDBSession
  {
    ...
    function all(onResult:Function=null, onFault:Function=null):void; // Connected users
    function destroy(cookie:String, onResult:Function=null, onFault:Function=null):void; // Disconnect user
  }
}