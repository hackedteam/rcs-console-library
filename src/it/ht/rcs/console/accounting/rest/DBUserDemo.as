package it.ht.rcs.console.accounting.rest
{
  ...
  public class DBUserDemo implements IDBUser
  {
    ...
    public function all(onResult:Function=null, onFault:Function=null):void
    {
      ...
      var a:Array = [
        new User({ _id: '2',  name: 'alor',   group_ids: ['1', '2'], enabled: true,  privs: new ArrayCollection(['ADMIN', 'SYS', 'TECH', 'VIEW']), locale: 'en_US' }),
        new User({ _id: '3',  name: 'daniel', group_ids: ['1', '2'], enabled: true,  privs: new ArrayCollection(['ADMIN', 'SYS', 'TECH', 'VIEW']), locale: 'it_IT' }),
        new User({ _id: '4',  name: 'naga',   group_ids: ['2'],      enabled: true,  privs: new ArrayCollection(['VIEW']) }),
        new User({ _id: '5',  name: 'que',    group_ids: ['2'],      enabled: false }),
        new User({ _id: '6',  name: 'zeno',   group_ids: ['2'],      enabled: true,  privs: new ArrayCollection(['TECH', 'VIEW']) }),
        new User({ _id: '7',  name: 'rev',    group_ids: ['2'],      enabled: false }),
        new User({ _id: '8',  name: 'kiodo',  group_ids: ['2'],      enabled: false }),
        new User({ _id: '9',  name: 'fabio',  group_ids: ['2'],      enabled: false }),
        new User({ _id: '10', name: 'br1',    group_ids: ['3'],      enabled: false, privs: new ArrayCollection(['SYS']) })
      ];
