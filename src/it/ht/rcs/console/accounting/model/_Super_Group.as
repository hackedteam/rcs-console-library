...
public class _Super_Group extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    private var _internal_item_ids : ArrayCollection;
    ...
    public function _Super_Group()
    {
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "item_ids", model_internal::setterListenerItem_ids));
    ...
    [Bindable(event="propertyChange")]
    public function get item_ids() : ArrayCollection
    {
    ...
    public function set item_ids(value:*) : void
    {
        var oldValue:ArrayCollection = _internal_item_ids;
        if (oldValue !== value)
        {
            if (value is ArrayCollection)
            {
                _internal_item_ids = value;
            }
            else if (value is Array)
            {
                _internal_item_ids = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_item_ids = null;
            }
            else
            {
                throw new Error("value of item_ids must be a collection");
            }
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "item_ids", oldValue, _internal_item_ids));
        }
    }
    ...
    model_internal function setterListenerItem_ids(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            if (mx.events.PropertyChangeEvent(value).newValue)
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerItem_ids);
            }
        }
        _model.invalidateDependentOnItem_ids();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.item_idsIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_item_idsValidationFailureMessages);
        }
    ...
    model_internal var _doValidationCacheOfItem_ids : Array = null;
    model_internal var _doValidationLastValOfItem_ids : ArrayCollection;

    model_internal function _doValidationForItem_ids(valueIn:Object):Array
    {
        var value : ArrayCollection = valueIn as ArrayCollection;

        if (model_internal::_doValidationCacheOfItem_ids != null && model_internal::_doValidationLastValOfItem_ids == value)
           return model_internal::_doValidationCacheOfItem_ids ;

        _model.model_internal::_item_idsIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isItem_idsAvailable && _internal_item_ids == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "item_ids is required"));
        }

        model_internal::_doValidationCacheOfItem_ids = validationFailures;
        model_internal::_doValidationLastValOfItem_ids = value;
