...
internal class _ForwarderEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal var _destIsValid:Boolean;
    model_internal var _destValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _destIsValidCacheInitialized:Boolean = false;
    model_internal var _destValidationFailureMessages:Array;
    ...
    public function _ForwarderEntityMetadata(value : _Super_Forwarder)
    {
        ...
        model_internal::_destValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForDest);
        model_internal::_destValidator.required = true;
        model_internal::_destValidator.requiredFieldError = "dest is required";
        //model_internal::_destValidator.source = model_internal::_instance;
        //model_internal::_destValidator.property = "dest";
    ...
    [Bindable(event="propertyChange")]
    public function get isRawAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isDestAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnDest():void
    {
        if (model_internal::_destIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfDest = null;
            model_internal::calculateDestIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get rawStyle():com.adobe.fiber.styles.Style
    {
    ...
    [Bindable(event="propertyChange")]   
    public function get destStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get destValidator() : StyleValidator
    {
        return model_internal::_destValidator;
    }

    model_internal function set _destIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_destIsValid;         
        if (oldValue !== value)
        {
            model_internal::_destIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "destIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get destIsValid():Boolean
    {
        if (!model_internal::_destIsValidCacheInitialized)
        {
            model_internal::calculateDestIsValid();
        ...
        return model_internal::_destIsValid;
    }

    model_internal function calculateDestIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_destValidator.validate(model_internal::_instance.dest)
        model_internal::_destIsValid_der = (valRes.results == null);
        model_internal::_destIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::destValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::destValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get destValidationFailureMessages():Array
    {
        if (model_internal::_destValidationFailureMessages == null)
            model_internal::calculateDestIsValid();

        return _destValidationFailureMessages;
    }

    model_internal function set destValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_destValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_destValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "destValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("dest"):
            {
                return destValidationFailureMessages;
            }
            case("_id"):
            {
