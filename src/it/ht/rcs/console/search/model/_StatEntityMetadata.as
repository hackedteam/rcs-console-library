...
internal class _StatEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("last_sync", "source", "_id", "last_sync_status", "grid_size", "evidence", "dashboard", "device", "user", "size", "last_child");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("last_sync_status");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("last_sync", "source", "_id", "last_sync_status", "grid_size", "evidence", "dashboard", "device", "user", "size", "last_child");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("last_sync", "source", "_id", "last_sync_status", "grid_size", "evidence", "dashboard", "device", "user", "size", "last_child");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("last_sync", "source", "_id", "last_sync_status", "grid_size", "evidence", "dashboard", "device", "user", "size", "last_child");
    ...
    public function _StatEntityMetadata(value : _Super_Stat)
    {
        ...
        model_internal::propertyTypeMap["dashboard"] = "Object";
