...
internal class _LicenseEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("users", "exploits", "maintenance", "agents", "alerting", "nia", "correlation", "type", "expiry", "collectors", "shards", "forwarders", "serial", "rmi");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("users", "exploits", "maintenance", "agents", "alerting", "nia", "correlation", "type", "expiry", "collectors", "shards", "forwarders", "serial", "rmi");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("users", "exploits", "maintenance", "agents", "alerting", "nia", "correlation", "type", "expiry", "collectors", "shards", "forwarders", "serial", "rmi");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("users", "exploits", "maintenance", "agents", "alerting", "nia", "correlation", "type", "expiry", "collectors", "shards", "forwarders", "serial", "rmi");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("users", "exploits", "maintenance", "agents", "alerting", "nia", "correlation", "type", "expiry", "collectors", "shards", "forwarders", "serial", "rmi");
