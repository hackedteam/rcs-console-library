...
internal class _EvidenceEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("da", "rel", "aid", "note", "dr", "blo", "blotter", "_id", "data", "relevance", "acquired", "received", "agent_id", "type", "_mid");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("da", "rel", "aid", "note", "dr", "blo", "blotter", "_id", "data", "relevance", "acquired", "received", "agent_id", "type", "_mid");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("da", "rel", "aid", "note", "dr", "blo", "blotter", "_id", "data", "relevance", "acquired", "received", "agent_id", "type", "_mid");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("da", "rel", "aid", "note", "dr", "blo", "blotter", "_id", "data", "relevance", "acquired", "received", "agent_id", "type", "_mid");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("da", "rel", "aid", "note", "dr", "blo", "blotter", "_id", "data", "relevance", "acquired", "received", "agent_id", "type", "_mid");
