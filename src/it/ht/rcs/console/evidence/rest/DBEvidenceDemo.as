package it.ht.rcs.console.evidence.rest
{
  ...
  public class DBEvidenceDemo implements IDBEvidence
  {
    ...
    public static var evidence:ArrayCollection = new ArrayCollection([
      ...
      new Evidence({_id: 'e16', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14, 57, 55)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14, 58, 54)), _mid: 0, note: '', rel: 0, type: 'addressbook', data: new EvidenceData({name: 'Jane Doe', contact: '', info: 'Screen name: Jane 67', program: 'skype', type: 'peer'})}),
      new Evidence({_id: 'e141', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14, 57, 55)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14, 58, 54)), _mid: 0, note: '', rel: 0, type: 'addressbook', data: new EvidenceData({name: 'Public wallet', contact: '15wB7ipHhmPyh6vKbuTCMbX5oNp3', info: 'Screen name: Jhone Doe', program: 'bitcoin', type: 'target'})}),
      ...
      new Evidence({_id: 'e19', aid: 'a1', blo: false, da: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14, 58, 01)), dr: convertToUnix(new Date(tenDaysAgo.fullYear, tenDaysAgo.month, tenDaysAgo.date, 14, 58, 58)), _mid: 0, note: '', rel: 0, type: 'addressbook', data: new EvidenceData({name: 'Faber O\'Connell', contact: '', info: 'Home address street: Kulim Facebook page: /f.c', program: 'facebook', type: 'peer'})}), 
