package it.ht.rcs.console.evidence.rest
{
    ...
    private static function convertToUnix(value:Date):String
    {
      ...
      //chat ! ALERTED
      new Evidence({_id: 'e24', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,50,51)), dr: convertToUnix(new Date(2012,11,03,14,57,00)), _mid: 0, note: '', rel: 4, type: 'chat', data: new EvidenceData({program: 'Twitter', from:'', from_display:'JimmyPage8000', content:'JimmyPage: Going to Nashville this weekend', tr:'JimmyPage: Going to Nashville this weekend'})}),
      ...
      //password
      new Evidence({_id: 'e02', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,53,54)), dr: convertToUnix(new Date(2012,11,03,14,58,42)), _mid: 0, note: '', rel: 0, type: 'password', data: new EvidenceData({user: 'jimmypage1337', pass: 'FrancoFranchi99', program: 'Firefox/Thunderbird', service: 'https://accounts.google.com'})}),
      
      new Evidence({_id: 'e03', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,53,54)), dr: convertToUnix(new Date(2012,11,03,14,58,42)), _mid: 0, note: '', rel: 0, type: 'password', data: new EvidenceData({user: 'jimmypage1337@gmail.com', pass: 'FrancoFranchi99', program: 'Firefox/Thunderbird', service: 'http://www.facebook.com'})}),
      
      new Evidence({_id: 'e04', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,53,54)), dr: convertToUnix(new Date(2012,11,03,14,58,42)), _mid: 0, note: '', rel: 0, type: 'password', data: new EvidenceData({user: 'jimmypage8000', pass: 'FrancoFranchi99', program: 'Firefox/Thunderbird', service: 'https://twitter.com'})}),
      
      new Evidence({_id: 'e05', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,53,54)), dr: convertToUnix(new Date(2012,11,03,14,58,42)), _mid: 0, note: '', rel: 0, type: 'password', data: new EvidenceData({user: 'root', pass: 'admin', program: 'Firefox/Thunderbird', service: 'http://172.16.42.100'})}),
      
      //position
      new Evidence({_id: 'e06', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,53,59)), dr: convertToUnix(new Date(2012,11,03,14,58,43)), _mid: 0, note: '', rel: 0, type: 'position', 
      ...
      //camera
      new Evidence({_id: 'e35', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,53,59)), dr: convertToUnix(new Date(2012,11,03,14,58,43)), _mid: 0, note: '', rel: 0, type: 'camera', data: new EvidenceData({_grid:'50bcc583572d6e0d0000019b.jpg'})}),
      
      //mouse
      new Evidence({_id: 'e38', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,57,28)), dr: convertToUnix(new Date(2012,11,03,14,58,51)), _mid: 0, note: '', rel: 0, type: 'mouse', data: new EvidenceData({program:'explorer.exe',window:'FolderView',x:'44',y:'345',resolution:'1366 x 768', _grid:'50bcb01c572d6e0d00000017.jpg'})}),
      
      new Evidence({_id: 'e39', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,58,27)), dr: convertToUnix(new Date(2012,11,03,14,59,02)), _mid: 0, note: '', rel: 0, type: 'mouse', data: new EvidenceData({program:'Skype.exe',window:'UNKNOWN',x:'218',y:'268',resolution:'1366 x 768', _grid:'50bcb026572d6e0d0000004f.jpg'})}),
      ...
      //mouse
      new Evidence({_id: 'e41', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,15,12,15)), dr: convertToUnix(new Date(2012,11,03,15,13,48)), _mid: 0, note: '', rel: 0, type: 'mouse', data: new EvidenceData({program:'explorer.exe',window:'Shut down',x:'352',y:'702',resolution:'1366 x 768', _grid:'50bcb39c572d6e0d00000122.jpg'})}),
      
      //position
      new Evidence({_id: 'e07', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,16,36,26)), dr: convertToUnix(new Date(2012,11,03,16,37,33)), _mid: 0, note: '', rel: 0, type: 'position', 
      ...
      new Evidence({_id: 'e37', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,57,55)), dr: convertToUnix(new Date(2012,11,03,14,58,54)), _mid: 0, note: '', rel: 0, type: 'camera', data: new EvidenceData({ _grid:'50bcb01c572d6e0d0000001a.jpg'})}),
      
      //addresbook
      new Evidence({_id: 'e17', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,14,57,57)), dr: convertToUnix(new Date(2012,11,03,14,58,55)), _mid: 0, note: '', rel: 0, type: 'addressbook', data: new EvidenceData({name:'pangoeye@mailcatch.com',contact:'', info:'Screen name: Mark Klovenberg', program:'gmail', type:'peer'})}),
      ...
      //keylog
      new Evidence({_id: 'e10', aid: 'a1', blo: false, da: convertToUnix(new Date(2012,11,03,15,10,54)), dr: convertToUnix(new Date(2012,11,03,15,11,46)), _mid: 0, note: '', rel: 0, type: 'keylog', data: new EvidenceData({program: 'TrueCrypt.exe', window: 'TrueCrypt', content:'↵'})}),
      ...
      new Evidence({_id: 'e19', aid: 'a1', blo: false, da:  convertToUnix(new Date(2012,11,03,14,58,01)), dr:  convertToUnix(new Date(2012,11,03,14,58,58)), _mid: 0, note: '', rel: 0, type: 'addressbook', data: new EvidenceData({name:'Faber O\'Connell',contact:'', info:'Home address street: Kulim Facebook page: /fabrizio.cornelli', program:'facebook', type:'peer'})}),
      new Evidence({_id: 'e20', aid: 'a1', blo: false, da:  convertToUnix(new Date(2012,11,03,14,58,01)), dr:  convertToUnix(new Date(2012,11,03,14,58,58)), _mid: 0, note: '', rel: 0, type: 'addressbook', data: new EvidenceData({name:'Radio Deejay',contact:'', info:'Screen name: radiodeejay', program:'twitter', type:'friend'})}),
