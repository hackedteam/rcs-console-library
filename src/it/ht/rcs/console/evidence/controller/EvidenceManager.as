package it.ht.rcs.console.evidence.controller
{
	...
	public class EvidenceManager extends ItemManager
	{
		...
		public function EvidenceManager()
		{
			super(Evidence);
		}
		...
		public static function get instance():EvidenceManager
		{
			return _instance;
		}
		...
		{
			if (event.property == 'data')
				return; // TODO: temporary fix. when applying filters, an update to "data" fires... ?
