...
internal class _EntityEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("photos", "updated_at", "level", "desc", "_id", "name", "path", "created_at", "type");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("photos", "updated_at", "level", "desc", "_id", "name", "path", "created_at", "type");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("photos", "updated_at", "level", "desc", "_id", "name", "path", "created_at", "type");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("photos", "updated_at", "level", "desc", "_id", "name", "path", "created_at", "type");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("photos", "updated_at", "level", "desc", "_id", "name", "path", "created_at", "type");
    ...
    public function _EntityEntityMetadata(value : _Super_Entity)
    {
        ...
        model_internal::propertyTypeMap["photos"] = "Object";
