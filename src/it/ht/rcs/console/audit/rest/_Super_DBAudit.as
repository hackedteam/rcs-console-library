 ...
 * of this service wrapper you may modify the generated sub-class of this class - DBAudit.as.
 */
...
[ExcludeClass]
internal class _Super_DBAudit extends com.adobe.fiber.services.wrapper.HTTPServiceWrapper
{
    ...
    // Constructor
    public function _Super_DBAudit()
    {
        ...
        _auditRPCDataManager.itemClass = it.ht.rcs.console.audit.model.Audit; 
        ...
        dmQuery.propertySpecifier = "agent_name,operation_name,time,desc,_id,target_name,action,actor,group_name,user_name";
