 ...
 * of this service wrapper you may modify the generated sub-class of this class - DBOperation.as.
 */
...
[ExcludeClass]
internal class _Super_DBOperation extends com.adobe.fiber.services.wrapper.HTTPServiceWrapper
{
    ...
    public function _Super_DBOperation()
    {
        ...
        operation.resultType = it.ht.rcs.console.operation.model.Operation;
         operations.push(operation);
        ...
        operation.resultType = it.ht.rcs.console.operation.model.Operation;
         ...
         operation.url = "/operation/update";
         operation.method = "POST";
         operation.serializationFilter = serializer0;
         operation.contentType = "application/xml";
        operation.resultType = it.ht.rcs.console.operation.model.Operation;
         ...
         operation.url = "/operation/destroy";
         operation.method = "POST";
    ...
    /**
      ...
      */
    public function all_(all:Boolean) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("all_");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(all) ;
