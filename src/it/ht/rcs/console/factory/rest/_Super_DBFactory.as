 ...
 * of this service wrapper you may modify the generated sub-class of this class - DBFactory.as.
 */
...
[ExcludeClass]
internal class _Super_DBFactory extends com.adobe.fiber.services.wrapper.HTTPServiceWrapper
{
    private static var serializer0:JSONSerializationFilter = new JSONSerializationFilter();
    private static var serializer1:XMLSerializationFilter = new XMLSerializationFilter();

    // Constructor
    public function _Super_DBFactory()
    {
        ...
        _serviceControl = new mx.rpc.http.HTTPMultiService("https://localhost:4443");
         ...
         operation.url = "/factory";
         operation.method = "GET";
         operation.serializationFilter = serializer0;
         operation.resultElementType = it.ht.rcs.console.factory.model.Factory;
         operations.push(operation);

         operation = new mx.rpc.http.Operation(null, "show_");
         operation.url = "/factory/{id}";
         operation.method = "GET";
         ...
         operation.resultType = it.ht.rcs.console.factory.model.Factory;
         operations.push(operation);
         ...
         operation.url = "/factory/add_config";
         operation.method = "POST";
         operation.serializationFilter = serializer0;
         operation.contentType = "application/xml";
